...
namespace Ms.AppTTQH.Web.Menus;

public class AppTTQHMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public AppTTQHMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<AppTTQHResource>();
    ...
    private Task ConfigureUserMenuAsync(MenuConfigurationContext context)
    {
        ...
        context.Menu.AddItem(new ApplicationMenuItem("Account.Manage", l["MyAccount"],
